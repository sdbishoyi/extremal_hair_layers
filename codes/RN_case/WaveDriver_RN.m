...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[r_sch,r_schm2m] = RstarToR_RN(rstar_adj,M,Q);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pot_sch=-(ell*(ell + 1)./r_sch.^4 + (2*M - 2*Q^2./r_sch)./r_sch.^5).*...
     (r_sch.^2 -2*M.*r_sch + Q^2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 Pot_inf = ((omega-x_64.*omegaP)./(1+capH))...
     .*((x.^2-2*M*omega.*x + Q^2.*omega.^2)./x.^2)...
     .*(-(2*M - 2*Q^2.*omega./x).*omega./x.^3 - ell.*(ell+1)./x.^2);
...
[psiarr,piarr,phiarr,tarr] = Wave1D_RN(init_con,dg_globals,phys_system,FinalTime);
tarr=cell2mat(tarr);
