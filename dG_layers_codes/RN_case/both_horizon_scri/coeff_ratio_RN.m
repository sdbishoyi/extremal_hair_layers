last = 500;
%coeff1 = (slope1(end-last:end)+2).*(tarr(end-last:end));
%time_array = log10(tarr(end-last:end));

y_fit = tarr(end-last:end).^3.*psi_extr(end-last:end);
x_fit = tarr(end-last:end);
