function [Psi_arr,Pi_arr,Phi_arr,t_arr] = Wave1D_RN(init_con,dg_globals,phys_system,FinalTime) 
...
for tstep=1:Nsteps
   for INTRK = 1:5
      ...
      [rhsPsi,rhsPi, rhsPhi] = WaveRHS1D_RN(Psi,Pi,Phi,dg_globals,phys_system,timelocal);
